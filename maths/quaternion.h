...
#define VERSOR_EPSILON 0.001f // 0.999 < ||q|| < 1.001
...
void  quat_normalise(float* q);           // ||q|| = 1 (+- VERSOR_EPSILON)
...
void quat_rot(float* q, float* p);   // p = (q)(p)(q)
void quat_rot_v(float* q, float* v); // v = (q)(v)(q*)
